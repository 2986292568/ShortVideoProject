                ...
                .execute(new JsonCallback<User>() {
                    ...
                    public void onSuccess(ApiResponse<User> response) {
                        if (response.body != null) {
                            ...
                            runOnUiThread(() -> Toast.makeText(getApplicationContext(), "登陆失败", Toast.LENGTH_SHORT).show());
                        }
                    }

                    @Override
                    public void onError(ApiResponse<User> response) {
                        runOnUiThread(() -> Toast.makeText(getApplicationContext(), "登陆失败,msg:" + response.message, Toast.LENGTH_SHORT).show());
                    }
                });
    }
